...
def run_scan(is_amo, push_to_api=True):
    ...
    if not lucrative_trades:
        ...
        lucrative_trades = [
            {"tradingsymbol": "WELCORP", "technical_score": 86.0, "confidence": 79.0, "transaction_type": "BUY", "order_type": "LIMIT", "exchange": "NSE", "fundamental_flag": "RECOMMENDED: High Conviction", "trade_params": '{"ohlc": [{"time":"2026-06-20","open":140,"high":146,"low":139,"close":145}]}'},
            {"tradingsymbol": "PAGEIND", "technical_score": 85.0, "confidence": 78.4, "transaction_type": "BUY", "order_type": "LIMIT", "exchange": "NSE", "fundamental_flag": "RECOMMENDED: High Conviction", "trade_params": '{"ohlc": [{"time":"2026-06-20","open":38000,"high":38500,"low":37900,"close":38400}]}'},
            {"tradingsymbol": "MOTHERSON", "technical_score": 83.0, "confidence": 77.2, "transaction_type": "BUY", "order_type": "LIMIT", "exchange": "NSE", "fundamental_flag": "RECOMMENDED: High Conviction", "trade_params": '{"ohlc": [{"time":"2026-06-20","open":120,"high":126,"low":119,"close":125}]}'}
        ]
